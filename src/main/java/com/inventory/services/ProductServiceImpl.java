...
public class ProductServiceImpl implements IProductService {
	...
	/*
	 * es utilizada en el contexto de transacciones en aplicaciones que usan
	 * frameworks como Spring Framework para manejar la capa de persistencia.
	 */
	public ResponseEntity<ProductResponseRest> searchById(Long id) {
		...
		try {
			...
			if (product.isPresent()) {
				// agregamos una variable de tipo byte y se descomprime en formato base 64
				byte[] imageDescompressed = Util.decompressZLib(product.get().getPicture());
				// después de descomprimirla se setea 
